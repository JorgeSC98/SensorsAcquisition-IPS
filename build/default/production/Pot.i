...
void Pot_Change(uint8_t sensor, _Bool direction, uint8_t amount);
void Pot_Reset_Vref();
void Pot_Increase_Vref(uint8_t amount);
void Pot_Decrease_Vref(uint8_t amount);
void Pot_Set_Vref(uint8_t amount);
void Pot_Change_Vref(_Bool direction, uint8_t amount);
void Pot_Selector(uint8_t sensor, _Bool status);
...
void Pot_Selector(uint8_t sensor, _Bool status){
    switch (sensor){
        case 0:
            LATDbits.LATD0=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 1:
            LATDbits.LATD1=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 2:
            LATDbits.LATD2=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 3:
            LATDbits.LATD3=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 4:
            LATDbits.LATD6=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 5:
            LATDbits.LATD7=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 6:
            LATDbits.LATD4=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 7:
            LATDbits.LATD5=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
        case 8:
            LATBbits.LATB6=status;
            _delay((unsigned long)((5)*(8000000/4000.0)));
            break;
    }
}
